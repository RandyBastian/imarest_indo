<?php 
	...
	*/
	class Event_model extends CI_Model
	{
		...
		{
			return $this->db->query("SELECT * FROM event WHERE (event.tipe_event LIKE '%Event%' OR event.tipe_event LIKE '%Conferences%') ;");
		}

		function get_all_paging_sorting_event($jtStartIndex,$jtPageSize,$jtSorting)
		{
			return $this->db->query("SELECT * FROM event WHERE (event.tipe_event LIKE '%Event%' OR event.tipe_event LIKE '%Conferences%') ORDER BY '".$jtSorting."' LIMIT ".$jtStartIndex.",".$jtPageSize.";");
		}
		...
		function update_without_training($id,$nama,$lat,$lang,$kota,$negara,$tanggal_awal,$tanggal_akhir,$jam_awal,$jam_akhir,$tipe,$link,$detail){
			return $this->db->query("UPDATE event SET event.nama_event = '".$nama."', event.lat_event = '".$lat."',  event.lang_event = '".$lang."', event.id_kota_event = '".$kota."', event.id_negara_event = '".$negara."', event.tanggal_mulai_event= '".$tanggal_awal."',event.tanggal_akhir_event= '".$tanggal_akhir."',event.jam_mulai_event= '".$jam_awal."', event.jam_akhir_event='".$jam_akhir."',event.tipe_event='".$tipe."',event.register_event = '".$link."', event.detail_event = '".$detail."' WHERE event.id_event = '".$id."';");
		}

		function update_with_training($id,$nama,$lat,$lang,$kota,$negara,$tanggal_awal,$tanggal_akhir,$jam_awal,$jam_akhir,$tipe,$link,$gab,$detail){
			return $this->db->query("UPDATE event SET event.nama_event = '".$nama."', event.lat_event = '".$lat."',  event.lang_event = '".$lang."', event.id_kota_event = '".$kota."', event.id_negara_event = '".$negara."', event.tanggal_mulai_event= '".$tanggal_awal."',event.tanggal_akhir_event= '".$tanggal_akhir."',event.jam_mulai_event= '".$jam_awal."', event.jam_akhir_event='".$jam_akhir."',event.tipe_event='".$tipe."',event.register_event = '".$link."', event.pic_event = '".$gab."', event.detail_event = '".$detail."' WHERE event.id_event = '".$id."';");
		}

		function update_without_event($id,$nama,$lat,$lang,$kota,$negara,$tanggal_awal,$tanggal_akhir,$jam_awal,$jam_akhir,$tipe,$link,$detail){
			return $this->db->query("UPDATE event SET event.nama_event = '".$nama."', event.lat_event = '".$lat."',  event.lang_event = '".$lang."', event.id_kota_event = '".$kota."', event.id_negara_event = '".$negara."', event.tanggal_mulai_event= '".$tanggal_awal."',event.tanggal_akhir_event= '".$tanggal_akhir."',event.jam_mulai_event= '".$jam_awal."', event.jam_akhir_event='".$jam_akhir."',event.tipe_event='".$tipe."',event.register_event = '".$link."', event.detail_event = '".$detail."' WHERE event.id_event = '".$id."';");
		}

		function update_with_event($id,$nama,$lat,$lang,$kota,$negara,$tanggal_awal,$tanggal_akhir,$jam_awal,$jam_akhir,$tipe,$link,$gab,$detail){
			return $this->db->query("UPDATE event SET event.nama_event = '".$nama."', event.lat_event = '".$lat."',  event.lang_event = '".$lang."', event.id_kota_event = '".$kota."', event.id_negara_event = '".$negara."', event.tanggal_mulai_event= '".$tanggal_awal."',event.tanggal_akhir_event= '".$tanggal_akhir."',event.jam_mulai_event= '".$jam_awal."', event.jam_akhir_event='".$jam_akhir."',event.tipe_event='".$tipe."',event.register_event = '".$link."', event.pic_event = '".$gab."', event.detail_event = '".$detail."' WHERE event.id_event = '".$id."';");
		}
